...
// Check if the "name" key is set in the $_SESSION array
...
// Check if the "city" key is set in the $_SESSION array
...
?>
            ...
            <td data-label="Action" style="margin:auto">
                <?php if ($row['delivery_by'] == null) { ?>
                    <form method="post" action="view_order.php"> <!-- Changed the action to view_order.php -->
